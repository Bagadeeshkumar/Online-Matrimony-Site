                ...
                <div class="modal-body">
                    <table class="table border rounded">
                        <tbody>
                            ...
                            $run8 = mysqli_query(
                                $conn,
                                "SELECT * FROM friend WHERE (receiver = $myid AND status = 0)"
                            );
                                ...
                                while ($row8 = mysqli_fetch_assoc($run8)) {
                                    ...
                                    while ($row9 = mysqli_fetch_assoc($run9)) {
                                        echo '
                                            ...
                                            $row9['img'] .
                                            '" style="width: 15%;" onerror="this.onerror=null; this.src=' .
                                            $_SESSION['dp'] .
                                            '"  alt="profile picture">' .
                                            ' ' .
                                            $row9['firstname'] .
                                            ...
                                            '</td>
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            <a href="function_db.php?sender=' .
                                            $row9['user_id'] .
                                            '" class="btn text-white btn-sm btn-success">Accept</a>
                                                            <a href="function_db.php?del=' .
                                            $row9['user_id'] .
                                            '" class="ml-2 btn text-white btn-sm btn-success">Decline</a>';
                ...
                <div class="modal-body">
                    <table class="table border rounded">
                        <tbody>
                            ...
                            $run16 = mysqli_query(
                                $conn,
                                "SELECT * FROM friend WHERE (sender = $myid AND status = 0)"
                            );
                                    ...
                                    while (
                                        ...
                                        echo '
                                            ...
                                            '</td>
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            <a href="function_db.php?c_req=' .
                                            $row17['user_id'] .
                                            '" class="ml-2 btn text-white btn-sm btn-danger">Cancel Request</a>';
                                        if ($_SESSION['my_status'] == 'P') {
                                            echo '<a href="userview.php?id=' .
                                                $row17['user_id'] .
                                                '" class="btn text-white btn-sm ml-2 btn-warning">View Details</a>';
                ...
                <div class="modal-body">
                    <table class="table border rounded">
                        <tbody>
                            ...
                            $run15 = mysqli_query(
                                $conn,
                                "SELECT * FROM friend WHERE ((receiver = $myid OR sender = $myid) AND status = 1)"
                            );
                            ...
                            if ($count_con > 0) {
                                while ($row15 = mysqli_fetch_assoc($run15)) {
                                    ...
                                    $run10 = mysqli_query(
                                        $conn,
                                        "SELECT * FROM user WHERE (user_id = $to_id OR user_id = $from_id) AND (user_id != $myid)"
                                    );
                                    while (
                                        ...
                                        echo '
                                            ...
                                            '</td>
                                                        <td>
                                                            <div class="d-flex justify-content-center">
                                                                <a href="function_db.php?rem=' .
                                            $row10['user_id'] .
                                            '" class="ml-2 btn text-white btn-sm btn-success">Remove</a>';
                                        if ($_SESSION['my_status'] == 'P') {
                                            echo '<a href="userview.php?id=' .
                                                $row10['user_id'] .
                                                '" class="btn text-white btn-sm ml-2 btn-warning">View Details</a>';
...
<nav class="fixed-top navbar navbar-expand-lg bg-dark">
    ...
    <div id="nav_u" class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link text-warning" href="#" data-backdrop="static" data-toggle="modal" data-target="#req_mod"><span><?php if (
                    !empty($count_req)
                ) {
                    echo '<span class="badge badge-danger px-1">' .
                        $count_req .
                        '</span>';
                } else {
            ...
            <li class="nav-item">
                <a class="nav-link text-warning" href="#" data-backdrop="static" data-toggle="modal" data-target="#s_req_mod"><span><?php if (
                    !empty($count_sreq)
                ) {
                    echo '<span class="badge badge-danger px-1">' .
                        $count_sreq .
            ...
            <li class="nav-item">
                <a class="nav-link text-warning" href="#" data-backdrop="static" data-toggle="modal" data-target="#con_mod"><span><?php if (
                    !empty($count_con)
                ) {
                    echo '<span class="badge badge-danger px-1">' .
                        $count_con .
            ...
            <li class="nav-item">
                <a class="nav-link text-warning" href="function_db.php?up=<?php echo $_SESSION[
                    'my_id'
                ]; ?>"><?php if ($_SESSION['my_status'] == 'F') {
    echo "<i class='fa fa-level-up fa-x mr-1'></i> Upgrade";
} ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-warning" href="profile.php"><i class="fa fa-user-circle fa-x mr-1"></i><?php echo $_SESSION[
                    'name'
                ]; ?></a>
            </li>
            <li class="nav-item">
