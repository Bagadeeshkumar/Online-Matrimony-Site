...
<nav class="fixed-top navbar navbar-expand-sm bg-dark">
    <a class="navbar-brand text-warning" href="#">Sai Matrimony</a>
    <form class="form-inline" action="userhome.php" method="POST">
        <input type="text" class="form-control mr-sm-2" name="search" placeholder="By username or id">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            <a class="nav-link text-warning" href="#" data-backdrop="static" data-toggle="modal" data-target="#s_req_mod"><span><?php 
                                                                                                                                if(!empty($count_sreq)){
                                                                                                                                    echo '<span class="bg-danger text-white px-1">'.$count_sreq.'</span>';
                                                                                                                                } 
                                                                                                                                else{
        ...
        <li class="nav-item">
            <a class="nav-link text-warning" href="#" data-backdrop="static" data-toggle="modal" data-target="#con_mod"><span><?php 
                                                                                                                                if(!empty($count_con)){
                                                                                                                                    echo '<span class="bg-danger text-white px-1">'.$count_con.'</span>';;
                                                                                                                                } 
                                                                                                                                else{
