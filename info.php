...
<body>
    ...
    <section class="main">
        ...
        <div class="p-3 border border-primary rounded container">

            <form action="function_db.php" method="POST" enctype="multipart/form-data">

                <h2 class="text-center p-2">Let's create your profile now</h2>
                ...
                <div class="form-group row">
                    ...
                    <div class="d-inline-flex col-sm-10">
                        ...
                        <input type="text" name="fi_name" class="form-control" id="Fname" placeholder="First Name" required>

                        <input type="text" name="l_name" class="form-control ml-3" id="Fname" placeholder="Last Name" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" name="caste" class="form-control" id="caste" placeholder="caste" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="tel" name="ph_no" class="form-control" id="ph_no" placeholder="phone number" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" name="f_name" class="form-control" id="f_name" placeholder="Father Name" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" name="m_name" class="form-control" id="m_name" placeholder="Mother Name" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" name="citizen" class="form-control" id="citizen" placeholder="Citizenship" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea name="a_me" class="form-control" rows="5" id="about" required></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input name="b_grp" type="text" class="form-control" id="blood" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input name="company" type="text" class="form-control" id="ljc" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input name="position" type="text" class="form-control" id="ljd" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input name="dist" type="text" class="form-control" id="dist" placeholder="eg. Madurai" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input name="pcode" type="text" class="form-control" id="code" placeholder="eg. 625 018" required>
                ...
                <h3 class="pb-2 text-primary">Preference</h3>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input name="p_caste" type="text" class="form-control" id="p_caste" placeholder="caste" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="offset-sm-5">
                        ...
                        <button type="submit" name="info_sub" class="btn btn-primary btn-lg">Submit</button>
