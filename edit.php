...
<body>
    ...
    <section class="main">
        <?php
        $view4 = mysqli_query($conn, "SELECT * FROM user WHERE user_id = '$myid'");
            ...
            <form action="function_db.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="d-inline-flex col-sm-10">
                        <input type="text" name="fi_name" class="form-control" id="Fname" value="' . $row5["firstname"] . '" required>
                        <input type="text" name="l_name" class="form-control ml-3" id="Fname" value="' . $row5["lastname"] . '" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" name="dob" class="form-control" id="dob" value="' . $row5["dob"] . '" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="caste" class="form-control" id="caste" value="' . $row5["caste"] . '" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="ph_no" class="form-control" id="ph_no" value="' . $row5["phno"] . '" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="f_name" class="form-control" id="f_name" value="' . $row5["f_name"] . '" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="m_name" class="form-control" id="m_name" value="' . $row5["m_name"] . '" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="citizen" class="form-control" id="citizen" value="' . $row5["citizenship"] . '" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="a_me" class="form-control" rows="5" id="about" value="' . $row5["a_me"] . '" required></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input name="b_grp" type="text" class="form-control" value="' . $row5["b_group"] . '" id="blood" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input name="company" type="text" class="form-control" id="ljc" value="' . $row5["l_comp"] . '" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input name="position" type="text" class="form-control" id="ljd" value="' . $row5["l_des"] . '" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="address" class="form-control" rows="5" id="address" value="' . $row5["address"] . '" required></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input name="dist" type="text" class="form-control" id="dist" value="' . $row5["dist"] . '" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input name="pcode" type="text" class="form-control" id="code" value="' . $row5["p_code"] . '" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input name="p_caste" type="text" class="form-control" id="p_caste" value="' . $row5["p_caste"] . '" required>
                    </div>
                </div>
